...
function App() {
  ...
  // If on contact page, render ContactPage component
  ...
  return (
    <div className={`min-h-screen bg-stone-50 text-gray-900 transition-all duration-1000 ${isLoaded ? 'opacity-100' : 'opacity-0'}`}>
