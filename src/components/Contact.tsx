      ...
      <div className="container mx-auto px-6 sm:px-8 lg:px-12">
        <div className={`text-center mb-16 transition-all duration-1000 ${
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            ...
            I'm always excited to tackle new challenges and collaborate with creative minds.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className={`transition-all duration-1000 delay-200 ${
            ...
            <div className="space-y-8">
              {contactInfo.map((info, index) => (
                <div 
                  key={index}
                  className="flex items-center space-x-4 p-6 bg-white border border-gray-200 rounded-xl hover:border-green-300 hover:shadow-lg hover:shadow-green-100 transition-all duration-300 group"
                >
          ...
          <div className={`transition-all duration-1000 delay-400 ${
            ...
            <form ref={formRef} onSubmit={handleSubmit} className="bg-white border border-gray-200 rounded-2xl p-8">
              {error && (
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-6">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-lg text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all duration-300"
                    placeholder="John"
                  />
              ...
              <div className="mb-6">
                ...
                <textarea
                  ...
                  required
                  rows={5}
                  className="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-lg text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all duration-300 resize-none"
